"""Commit the v5 reveal on-chain (miner side) with a preview + Y/N + registration check."""
...
def build_reveal(ref: ModelRef) -> str:
    """The on-chain payload: ``v5|<repo>|<digest>`` (matches chain_reader's v5 parser)."""
    return f"v5|{ref.repo}|{ref.digest}"
