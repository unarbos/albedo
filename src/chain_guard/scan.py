...
Where chain_reader.chain.scan_commitments narrows to well-formed v6 reveals, chain_guard needs
*everything* (v6, v5, v4, v3, …) to seed the legacy ledger. It reuses chain_reader's revealed-commit
