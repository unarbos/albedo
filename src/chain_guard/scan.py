...
Where chain_reader.chain.scan_commitments narrows to well-formed v7 reveals, chain_guard needs
*everything* (v7, v6, v5, v4, …) to seed the legacy ledger. It reuses chain_reader's revealed-commit
